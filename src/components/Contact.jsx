                    ...
                    <div className="contact-info reveal">
                        ...
                        <div className="contact-details">
                            ...
                            <div className="contact-links">
                                <a href="mailto:toms90305@gmail.com" className="contact-link">
                                    ...
                                    <div>
                                        ...
                                        <span className="link-value">toms90305@gmail.com</span>
                                    </div>
                                </a>

                                <a href="https://github.com/codexola" target="_blank" rel="noopener noreferrer" className="contact-link">
                                    <div className="contact-link-icon">
                                    ...
                                    <div>
                                        ...
                                        <span className="link-value">github.com/codexola</span>
                                    </div>
                                </a>
                                ...
                                <a href="/Hakimi Genji.pdf" download className="contact-link">
                                    <div className="contact-link-icon">
                                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="18" height="18">
